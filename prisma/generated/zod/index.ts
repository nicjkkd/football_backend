...
export const PlayerScalarFieldEnumSchema = z.enum(['id','firstName','lastName','dateBirth','position','playerNumber','teamId','createdAt','updatedAt']);

export const TeamScalarFieldEnumSchema = z.enum(['id','teamName','city','since','createdAt','updatedAt']);

export const LeagueScalarFieldEnumSchema = z.enum(['id','leagueName','createdAt','updatedAt']);

export const SortOrderSchema = z.enum(['asc','desc']);

export const NullsOrderSchema = z.enum(['first','last']);

export const PlayerOrderByRelevanceFieldEnumSchema = z.enum(['id','firstName','lastName','teamId']);

export const TeamOrderByRelevanceFieldEnumSchema = z.enum(['id','teamName','city']);

export const LeagueOrderByRelevanceFieldEnumSchema = z.enum(['id','leagueName']);

export const PositionSchema = z.enum(['BENCH','GK','SW','LB','LCB','CB','RCB','RB','LWB','LDM','CDM','RDM','RWB','LM','LCM','CM','RCM','RM','LW','LAM','CAM','RAM','RW','LS','CS','RS']);
